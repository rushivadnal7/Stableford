          ...
          <div className="border-t border-line">
            {FAQ.items.map((item) => (
              <details key={item.q} name="faq" className="group border-b border-line">
                <summary className="type-h4 flex list-none items-center justify-between gap-6 py-6 text-fg transition-colors hover:text-accent-text [&::-webkit-details-marker]:hidden">
                  {item.q}
